...
from utils_cifar import train, test, std, mean, get_hms
...
class VAE(Model):
    def __init__(self, args):
        ...
        # encoder: q(z | x)
        self.q_z_layers = iRevNet(nBlocks=[18,18], nStrides=[1,2],
                            nChannels=[16,64], nClasses=300,
                            init_ds=2, dropout_rate=0.1, affineBN=True,
                            in_shape=self.args.input_size, mult=4)
